...
namespace osu.Game.Rulesets.Catch.Tests
{
    public class CatchDifficultyCalculatorTest : DifficultyCalculatorTest
    {
        ...
        protected override DifficultyCalculator CreateDifficultyCalculator(IWorkingBeatmap beatmap, Mod[] mods) => new CatchDifficultyCalculator(new CatchRuleset().RulesetInfo, beatmap, mods);
