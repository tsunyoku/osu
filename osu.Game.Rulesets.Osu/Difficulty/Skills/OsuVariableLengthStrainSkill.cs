...
namespace osu.Game.Rulesets.Osu.Difficulty.Skills
{
    public abstract class OsuVariableLengthStrainSkill : VariableLengthStrainSkill
    {
        ...
        private double calculateNonReductionDifficultyValue()
        {
            double difficulty = 0;
        ...
        {
            double consistentTopStrain = calculateNonReductionDifficultyValue() / 10; // What would the top strain be if all strain values were identical
