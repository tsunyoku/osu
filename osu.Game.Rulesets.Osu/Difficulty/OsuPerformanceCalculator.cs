...
namespace osu.Game.Rulesets.Osu.Difficulty
{
    public class OsuPerformanceCalculator : PerformanceCalculator
    {
        ...
        private double computeSpeedValue(ScoreInfo score, OsuDifficultyAttributes attributes)
        {
            ...
            double speedValue = HarmonicSkill<OsuDifficultyHitObject>.DifficultyToPerformance(attributes.SpeedDifficulty);
        ...
        {
            double readingValue = HarmonicSkill<OsuDifficultyHitObject>.DifficultyToPerformance(attributes.ReadingDifficulty);
